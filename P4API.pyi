...
class P4Adapter:
    ...
    def set_env(self, var: str, val: str | None = None, /) -> bool: ...
    def run(self, cmd: str, /, *args: Any) -> Any: ...
    def format_spec(self, type_: str, dict_: dict[str, Any], /) -> str: ...
    def parse_spec(
        self, type_: str, form: str, /
    ) -> P4.Spec | dict[str, Any] | Literal[False]: ...
    ...
    def set_tunable(self, tunable: str, value: str, /) -> int: ...
    def get_tunable(self, tunable: str, /) -> int: ...
    ...
    @property
    def server_level(self) -> int: ...
    @property
    def server_case_insensitive(self) -> bool: ...
    @property
    def server_unicode(self) -> bool: ...
    logger: Logger | None
...
class P4Map:
    ...
    def clear(self) -> None: ...
    def translate(
        self, path: str, left_to_right: bool | Literal[0, 1] = True, /
    ) -> str | None: ...
    def translate_array(
        self, path: str, left_to_right: bool | Literal[0, 1] = True, /
    ) -> list[str] | None: ...
...
class P4Message:
    @property
    def severity(self) -> Literal[0, 1, 2, 3, 4]: ...
    @property
